    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/**","/api/sedes/**","/api/zonas/**","/api/usuarios/**","/api/tipoincidentes/**","/api/reportes/**","/swagger-ui/**","/swagger-ui-custom.html","/v3/**","/index.html/**", "/ws/**").permitAll()
